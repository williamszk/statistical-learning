 ...
 *     return a
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_name); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_v_a = (__pyx_t_1 * 10);
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_a); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     return a
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_n_s_name_2, __pyx_n_s_a); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 4, __pyx_L1_error)
